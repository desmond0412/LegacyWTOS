...
[CutsceneItem("Lev", "Set Input Action", CutsceneItemGenre.ActorItem)]
class LevSetInputAction : CinemaActorAction
{
	...
	void LevController_OnCustomAnimationFinished (GameObject sender)
	{
		sender.GetComponent<LevController>().setInputEnable(inputEnable);
	}
