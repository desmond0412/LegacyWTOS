...
[CutsceneItem("Naivis", "Force Start Event", CutsceneItemGenre.ActorItem)]
class NaivisForceStartHandler : CinemaActorEvent
{
	private Naivis ltScript;
