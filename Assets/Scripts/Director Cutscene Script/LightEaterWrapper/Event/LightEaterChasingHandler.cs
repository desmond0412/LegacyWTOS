...
[CutsceneItem("Light Eater", "Chasing Event", CutsceneItemGenre.ActorItem)]
class LightEaterChasingHandler : CinemaActorEvent
{
    private LightEaterMovementBezier ltScript;
    ...
    public override void Trigger(GameObject Actor)
    {
        if(Actor != null)
        {
            ltScript = Actor.GetComponent<LightEaterMovementBezier>();
            if(ltScript == null )
            {
            ...
            ltScript.isEnableChasing = enableChasing;
        }
    }
}
