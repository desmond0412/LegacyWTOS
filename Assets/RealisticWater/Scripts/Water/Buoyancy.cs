...
{
	public delegate void BuoyancyDelegate (GameObject sender);
	public event BuoyancyDelegate OnSplashOnWater;
    ...
    void OnTriggerEnter(Collider collidedObj)
    {
		...
		{
			waterRipples=temp;
			if(OnSplashOnWater!=null)
				OnSplashOnWater(this.gameObject);
		}
