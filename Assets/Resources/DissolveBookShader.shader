...
////// Lighting:
                ...
                fixed4 finalRGBA = fixed4(finalColor,(_AlphaMap_var.a*clamp(pow((((_DissolveMap_var.r*_DissolveIntensity)*5.0)+_DissolveIntensity),100.0),0,1)));
...
////// Lighting:
                ...
                float4 _AlphaMap_var = tex2D(_AlphaMap,TRANSFORM_TEX(i.uv0, _AlphaMap));
                float4 _DissolveMap_var = tex2D(_DissolveMap,TRANSFORM_TEX(i.uv0, _DissolveMap));
                fixed4 finalRGBA = fixed4(finalColor * (_AlphaMap_var.a*clamp(pow((((_DissolveMap_var.r*_DissolveIntensity)*5.0)+_DissolveIntensity),100.0),0,1)),0);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
